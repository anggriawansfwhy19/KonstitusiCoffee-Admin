...
import com.anggriawan.adminkonstitusicoffee.databinding.DeliveryItemBinding
        ...
        fun bind(position: Int) {
            binding.apply {
                ...
                if (moneyStatus[position] == true){
                    notReceivedTv.text = "Received"
                }else{
                    notReceivedTv.text = "NotReceived"
                }
                val colorMap = mapOf(
                    true to Color.GREEN, false to Color.RED
                )
                notReceivedTv.setTextColor(colorMap[moneyStatus[position]]?:Color.BLACK)
