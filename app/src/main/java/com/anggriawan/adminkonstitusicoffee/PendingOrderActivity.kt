...
import com.anggriawan.adminkonstitusicoffee.adapter.PendingOrderAdapter
import com.anggriawan.adminkonstitusicoffee.databinding.ActivityPendingOrderBinding
...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    private var listOfImageFirstCoffeeOrder : MutableList<String> = mutableListOf()
    ...
    private fun addDataToListForRecyclerView() {
        for (orderItem in listOfOrderItem){
            ...
            orderItem.coffeeImages?.filterNot { it.isEmpty() }?.forEach {
                listOfImageFirstCoffeeOrder.add(it)
            }
        }
        setAdapter()
    }
    ...
    private fun setAdapter() {
        ...
        val adapter = PendingOrderAdapter(this, listOfName, listOfTotalPrice, listOfImageFirstCoffeeOrder, this)
    ...
    private fun updateOrderAcceptStatus(position: Int) {
        //update order acceptance in user's
